...
# Security settings
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-default-secret-key-for-development')
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Добавлено для кастомных шаблонов
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Static files
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Добавлено для статических файлов
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Или IsAuthenticatedOrReadOnly
    ],
...
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER or 'noreply@lms.example.com'
